...
export function toCosmosAddress(ethAddress: string, prefix = 'novaichain') {
  const ethAddressBytes = fromHex(ethAddress.slice(2));
  return toBech32(prefix, ethAddressBytes);
}

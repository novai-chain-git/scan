...
<template>
  <div class="">
    <div class="px-4 pt-3 pb-4 bg-base-200 rounded mb-4 shadow ">
      <div class="mx-auto max-w-7xl px-6 lg:!px-8">
        <dl class="grid grid-cols-1 gap-x-6 text-center lg:!grid-cols-3">
          ...
          <div class="mx-auto flex items-center rounded-center">
    ...
    <div class="  pt-3 pb-4 rounded mb-4 shadow">
      <h2 class="card-title text-2xl mb-4 overflow-hidden">{{ $t('ibc.title_2') }}
      ...
      <div class="overflow-x-auto grid grid-cols-1 md:grid-cols-2 gap-4">
        <table class="table table-sm capitalize">
          <thead class="bg-base-200">
            <tr>
              <th colspan="3">{{ $t('ibc.trust_parameters') }}</th>
            </tr>
          </thead>
          <tbody>
            <tr>
    ...
    <div class="  pt-3 pb-4 rounded mb-4 shadow overflow-hidden">
      <h2 class="card-title text-2xl">{{ $t('ibc.channels') }}</h2>
        ...
        <table class="table w-full mt-4">
          ...
          <tbody>
            ...
            <tr v-for="v in channels">
              ...
              <td>{{ v.port_id }}</td>
              <td>
                <div class="text-xs truncate relative  rounded-full w-fit" :class="`text-${color(v.state)}`">
...
<!--    //v-if="channel_id"-->
    <div >
      <h3 class=" card-title text-2xl capitalize">Transactions ({{ channel_id }} {{ port_id }} {{ direction }}) </h3>

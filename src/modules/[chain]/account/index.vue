...
<template>
    <div class=" overflow-x-auto border border-[#FFFFFF]/[.16] bg-[#131315]/[.8] rounded-[16px] text-[#ffffff]">
        <table class="table table-compact">
            <thead>
                <tr>
                    <td class="text-[12px] text-[#ffffff]/[.54] font-[400]">{{ $t('account.type') }}</td>
                    <td class="text-[12px] text-[#ffffff]/[.54] font-[400]">{{ $t('account.address') }}</td>
                    <td class="text-[12px] text-[#ffffff]/[.54] font-[400]">{{ $t('account.acc_num') }}</td>
                    <td class="text-[12px] text-[#ffffff]/[.54] font-[400]">{{ $t('account.sequence') }}</td>
                    <td class="text-[12px] text-[#ffffff]/[.54] font-[400]">{{ $t('account.pub_key') }}</td>
                </tr>
            </thead>

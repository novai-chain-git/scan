...
<template>
  <div>
    <!--  -->
    <div class="bg-base-100 px-8 pt-11 pb-11 shadow">
    ...
    <!-- update -->
    <div class="bg-base-100 p-4 shadow" v-if="roundState['height/round/step']">
    ...
    <!-- alert-info -->
    <div class="text-[#4352D4] shadow mt-4 alert-info">
      <div class="drop-shadow-md px-4 pt-2 pb-2">
        <h2 class="text-base text-tips font-semibold">
          {{ $t('consensus.tips') }}
        </h2>
      </div>
      <div class="px-4 py-4">
...
.input-group > :first-child {
  height: 100%;
  background-color: rgba(111, 65, 255, 0);
  //height: 2.5rem;
  //min-height: 2.5rem;
}
.btn {

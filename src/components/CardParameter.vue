...
<template>
  <div
    class="bg-base-100 CardParameter px-8 pt-3 pb-4 rounded mt-5"
    v-if="props.cardItem?.items && props.cardItem?.items?.length > 0"
  >
    <div class="text-2xl text-title mb-3 text-main">
    ...
    >
      ...
      >
        <div class="text-sm mb-2 text-secondary capitalize">
